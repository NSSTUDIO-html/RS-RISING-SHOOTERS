...
import { createGun } from '/storage/emulated/0/sni1.js';
...
const texture1 = textureLoader53.load('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQT76ZYrDa-rqj4d6Z9yNBgzfbZGqYU77XbAK1ZEDoxJScgOnOaX9ztlxc&s=10');
   const texture2 = textureLoader53.load('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTxMAENWVbniuzGMcdMJ_6FFaqd8qU6tg9IP6f-rq9YkFn6dAP6Ils6dmp5&s=10');
    const texture3 = textureLoader53.load('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSyk4G2tRHIAZpEKMk7XcXXD9Tl3xb1dONsN1HpOkIWQ5Xj75_PtglqUam0&s=10');
   ...
   const barrelMaterial4 = new THREE.MeshPhongMaterial({ map:texture1 ,metalness:0.85,roughness:0.0,envMap:scene.environment});
    ...
    const barrelMaterial3 = new THREE.MeshStandardMaterial({ map:texture1,metalness:0.1,roughness:0.1,envMap:scene.environment});
...
armysuit.add( sphere );
 ...
 export function csuit(scene){
     const vs = new THREE.Group();
     vs.add(armysuit);
     const gun = createGun();
     gun.position.set(-1, 23, 50);
